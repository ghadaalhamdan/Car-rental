...
//declare to read menu choices	
		...
		do {// main menu
			...
			case 1: // manager
				...
				}while(managerchoice != 5);// end do manager menu	
			...
			case 2 ://customer menu
                ...
                case 1 :// Booking Process
                	...
                	do {// checking the id length
                     ...
                     if(customerId.charAt(i)>='0' && customerId.charAt(i)<='9')
                    	 numberOfDigits++;
                     if(numberOfDigits==10 && customerId.length()==10)
                    	 validId=true;
                     else
                    	 validId=false;
                ...
                case 3://most popular
                	...
                	getPopularItem(item1, item2,item3,item4);
                	break;
               ...
               default:
				...
				}while(customerChoice!=4);//end do customer menu
		...
		}while(choice1!= 3);//end  do main menu
